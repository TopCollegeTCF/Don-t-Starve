...
> **Важно:** вклад каждого участника измеряется внесенными изменениями в ветку своей команды и отражается в итоговом результате как вклад в глобальную разработку игры. Прочитать про это больше можно здесь  [➡️ WIKI ](https://github.com/TopCollegeTCF/Don-t-Starve/wiki/Командный-проект-по-созданию-веб-игры)
